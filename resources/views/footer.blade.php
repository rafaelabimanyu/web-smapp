...
<!-- ====================== MOTTO BERJALAN ====================== -->
<section
    class="relative flex items-center justify-between bg-gradient-to-r from-purple-900 via-purple-800 to-purple-700 overflow-hidden">
    ...
    <div class="relative flex items-center gap-3 md:gap-4 pr-4 md:pr-10 z-20">
        <div
            class="relative z-10 flex items-center justify-center w-10 h-10 md:w-16 md:h-16 rounded-full border-4 border-white shadow-lg bg-white">
            <img src="{{ asset($footerLogoPath) }}" alt="Logo Sekolah" width="{{ $footerLogoSize[0] }}"
                height="{{ $footerLogoSize[1] }}" class="max-h-full max-w-full object-contain">
        </div>
...
<footer class="relative bg-[#080c1b] text-gray-300 overflow-hidden">
    ...
    <div
        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left gap-6">
            <div
                class="flex items-center justify-center w-20 h-20 rounded-full border-2 border-purple-500 shadow-xl bg-white">
                <img src="{{ asset($footerLogoPath) }}" alt="Logo" width="{{ $footerLogoSize[0] }}"
                    height="{{ $footerLogoSize[1] }}" class="max-h-full max-w-full object-contain">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="text-sm text-gray-400 space-y-3 mt-4">
                    <li class="flex items-center gap-3"><i class="ri-phone-line text-purple-400 text-base"></i><span>+62
                            851-9592-8886</span></li>
                    <li class="flex items-center gap-3"><i
                            class="ri-mail-line text-purple-400 text-base"></i><span>sma.prestasiprima.sch.id</span>
                    </li>
                    <li class="flex items-center gap-3"><i
                            class="ri-building-4-line text-purple-400 text-base"></i><span>Jl. Hankam Raya No. 89,
                            Cilangkap, Cipayung,Jakarta Timur, DKI Jakarta.</span></li>
                    <li class="flex items-center gap-3"><i
                            class="ri-time-line text-purple-400 text-base"></i><span>Senin
            ...
            <div>
                ...
                <ul class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-400 mt-4">
                    ...
                    <li><a href="/siswa/ekstrakurikuler" class="hover:text-purple-400 transition">Ekstrakurikuler</a>
                    </li>
                    <li><a href="https://spmb.prestasiprima.sch.id/"
                            class="hover:text-purple-400 transition">Pendaftaran</a></li>
            ...
            <div>
                ...
                <ul class="text-sm text-gray-400 space-y-3 mt-4">
                    <li><a href="/dokumentasi/kegiatan" class="hover:text-purple-400 transition">Kegiatan Sekolah</a>
                    </li>
                    <li><a href="{{ url('/#beasiswa') }}" class="hover:text-purple-400 transition">Beasiswa &
                            Prestasi</a></li>
                    <li><a href="/informasi/lulusan-ptn" class="hover:text-purple-400 transition">Alumni Lulusan PTN</a>
                    </li>
                    <li><a href="/tentang/kurikulum" class="hover:text-purple-400 transition">Kurikulum & Metode
                            Pembelajaran</a></li>
                    <li><a href="{{ asset('assets/files/brosur.pdf') }}" download
                            class="hover:text-purple-400 transition">Download Brosur</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400 mt-4">
                    <li>
                        ...
                        <a href="https://spmb.prestasiprima.sch.id/" class="text-purple-400 hover:underline">laman
                            online</a>
                    ...
                    <li>
                        ...
                        Kunjungi
                        <a href="https://spmb.prestasiprima.sch.id/" class="text-purple-400 hover:underline">Hubungi
                            Kami</a>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-12 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <div
                ...
                <iframe
                    ...
                    title="Lokasi SMA Prestasi Prima">
                </iframe>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-between">
            ...
            @php
                $supportLogoPaths = [['path' => 'assets/images/support/logo.png', 'alt' => 'Support Logo']];
                $supportLogos = [];
...
<div class="relative z-10 border-t border-white/10 bg-gradient-to-b from-[#070b18] to-[#040713] py-12">
    <div class="max-w-7xl mx-auto px-6 md:px-10 text-center">
        ...
        <div class="flex justify-center mt-3">
            <span class="h-[2px] w-16 bg-gradient-to-r from-purple-500/70 to-purple-300/70 rounded-full"></span>
        </div>
        ...
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <!-- SMA -->
            <a href="https://sma.prestasiprima.sch.id/" target="_blank" rel="noopener">
                <div
                    ...
                    <div class="flex flex-col items-center gap-3">
                        <div
                            ...
                            <img src="{{ asset('assets/yayasan/logo_sma.png') }}"
            ...
            <!-- SMK -->
            <a href="https://smk.prestasiprima.sch.id/" target="_blank" rel="noopener">
                <div
                    class="group rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm
                           px-4 py-6 transition
                           hover:border-purple-500/30 hover:bg-white/[0.07]">
                    <div class="flex flex-col items-center gap-3">
                        <div
                            class="w-16 h-16 rounded-full bg-white flex items-center justify-center
                                   ring-2 ring-purple-500/20">
                            <img src="{{ asset('assets/yayasan/logo-smk.png') }}"
            ...
            <!-- Politeknik -->
            <a href="https://prestasiprima.ac.id/" target="_blank" rel="noopener">
                <div
                    class="group rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm
                           px-4 py-6 transition
                           hover:border-purple-500/30 hover:bg-white/[0.07]">
                    <div class="flex flex-col items-center gap-3">
                        <div
                            class="w-16 h-16 rounded-full bg-white flex items-center justify-center
                                   ring-2 ring-purple-500/20">
                            <img src="{{ asset('assets/yayasan/logo_politeknik.png') }}"
        ...
        <div
            ...
            <p class="flex items-center gap-2 text-gray-400">
             ...
             text-[11px] sm:text-sm font-semibold tracking-wide">
                    <a href="https://www.instagram.com/orensolutionspresma/" target="_blank"
            ...
            <p
                class="text-sm text-center md:text-right flex flex-wrap justify-center md:justify-end items-center gap-1">

                <!-- Developed by -->
                <a href="https://www.instagram.com/r.abimanyyy/" target="_blank" class="gradient-text-bold">
                ...
                <!-- Kelas -->
                <a href="https://www.instagram.com/xi_pplg1_/" target="_blank" class="kelas-link">
                    XI PPLG 1
                </a>
